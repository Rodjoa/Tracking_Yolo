...
class ObjectTracking:
    ...
    def __init__(self, model="yolo11s.pt", source= r"C:\ProyectosTEL\Respaldo_Conteo_Personas_PDI\Inputs\Av_Principal\Angulo_A.mp4"
...
if __name__ == "__main__":
    ...
    tracker = ObjectTracking(
        model="yolo11s.pt",
        source=r"C:\ProyectosTEL\Respaldo_Conteo_Personas_PDI\Inputs\Av_Principal\Angulo_A.mp4"
    )
    tracker.run()
