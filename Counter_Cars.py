...
class ObjectTracking:
    ...
    def __init__(self, model="yolo11s.pt", source= "Inputs/Autos/Carretera.mp4"): #yolo11s.pt, yolo11n.pt...Hay diferentes modelos. Hay que ir testeando
        ...
        self.movement_table = { #OBS: La llave del diccionario es (1,0,1,2,1,0) y el valor es "Girar derecha" ->{(1,0,2,1): Girar derecha}
            ...
            (
                0,0,1,
                1,0,1
            ): "movimiento_1",    #Automovil de la pista 1 (Pista 1 solo es en sentido hacia afuera a la pantalla) 1 gira a la derecha
            (
                0,0,1,
                2,0,1
            ): "movimiento_2",    #Automovil de la pista 1 sigue recto
            (
                0,0,1,
                3,0,1
            ): "movimiento_3",    #Automovil de la pista 1 gira a la izquierda
            (
                1,1,0,
                0,1,0
            ): "movimiento_4",    #Automovil de la pista 2 (Pista 2 solo es en sentido hacia dentro a la pantalla) Avanzan recto (no hay curvas)
...
if __name__ == "__main__":
    ...
    tracker = ObjectTracking(
        model="yolo11s.pt",
        source="Inputs/Autos/Carretera.mp4" 
    )
    tracker.run()
